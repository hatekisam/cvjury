          ...
          {data.map((rowData, i) => (
            ...
            >
              {tabs.map((tab, colIndex) => (
                ...
                //   }  px-4 py-2`}
		className={clsx("px-4 py-2",i == 0 && colIndex == 0 && "rounded-tl-[20px]",i ===data.length - 1 && colIndex === 0 && "rounded-bl-[20px]",colIndex!= 0 && colIndex<tabs.length -1 && "border",colIndex === tabs.length-1 && i != data.length -1 && "border-b border-l" )}
                >
